<div class="col-md-12 col-lg-4 sidebar">
    <div class="sidebar-box search-form-wrap">
        <form action="{{route('article.search')}}" class="search-form" method="GET">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="query" placeholder="Введите текст">
            </div>
        </form>
    </div>
    <!-- END sidebar-box -->
    <div class="sidebar-box">
        <div class="bio text-center">
            <img src="/wordify-master/images/danich.jpg" alt="Image Placeholder" class="img-fluid">
            <div class="bio-body">
                <h2>Craig David</h2>
                ...
                @foreach($latestArticles as $article)
                    <li>
                        <a href="{{route('article.show', [$article->category->slug, $article->slug])}}">
                            <img src="/uploads/{{$article->preview_image}}" alt="Image placeholder" class="mr-4">
                            <div class="text">
                                <h4>{{$article->title}}</h4>
                                <div class="post-meta">
                                    <span class="mr-2">{{$article->formatted_updated_at}}</span>
                                </div>
                            </div>
                        </a>
                    </li>
